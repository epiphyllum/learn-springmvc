package com.epiphyllum.learnmvc.chapter6.web.controller.mapping;
...
public class MappingController {
    ...
    //Ant风格的URL路径映射: /productx, producty
    ...
    //Ant风格的URL路径映射: /productxyz /productabc
    @RequestMapping(value="/product*")
    public String test33() {
        System.out.println("/product*  matches");
        return "mappingSuccess";
    }
    //Ant风格的URL路径映射: /product/abc, /product/xyz
    @RequestMapping(value="/product/*")
