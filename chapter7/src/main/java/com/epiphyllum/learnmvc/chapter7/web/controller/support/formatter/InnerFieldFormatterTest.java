...
public class InnerFieldFormatterTest {
	...
	public void test() throws SecurityException, NoSuchFieldException {
		...
		TypeDescriptor descriptor = new TypeDescriptor(FormatterModel.class.getDeclaredField("totalCount"));  // 构造方法
		
		TypeDescriptor stringDescriptor = TypeDescriptor.valueOf(String.class);  // 工厂方法
